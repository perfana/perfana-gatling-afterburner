...
pipeline {
   ...
   agent any
    ...
    parameters {
        ...
        string(name: 'employeeDbPassword', defaultValue: '', description: 'Employee db Password')
        ...
        stage('Checkout') {
            ...
            steps {
                ...
                script {
                    ...
                    git url: params.gatlingRepo, branch: "OptimusPrime-acme"
