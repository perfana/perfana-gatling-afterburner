...
pipeline {
   ...
   agent any
    ...
    parameters {
        string(name: 'perfana_url', defaultValue: 'http://perfana-auth-proxy.monitoring/perfana', description: 'Perfana url')
